...
export type GetResourceQuery = { __typename?: 'Query', resource: Array<{ __typename?: 'TypeResource', id: any, type: string, name: string, description: string, dataset?: { __typename?: 'DjangoModelType', pk: string } | null }> };
