...
export type DatasetResourcesQuery = { __typename?: 'Query', datasetResources: Array<{ __typename?: 'TypeResource', id: any, created: any, modified: any, type: string, name: string, description: string, accessModels: Array<{ __typename?: 'TypeResourceAccessModel', name: string, description: string, type: string }>, schema?: Array<{ __typename?: 'TypeResourceSchema', fieldName: string, id: string, format: string, description?: string | null }> | null }> };
